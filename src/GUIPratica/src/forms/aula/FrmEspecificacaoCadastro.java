 ...
 * @author Charles
 */
public class FrmEspecificacaoCadastro extends JDialogController {

    private int id;
    private final EspecificacaoService service = new EspecificacaoService();

    /**
     * Creates new form frmCadastroEspecificacao
     */
    public FrmEspecificacaoCadastro() {
        this(0);
    }

    public FrmEspecificacaoCadastro(int id) {
        super(frmMain.getInstance(), "Manutenção de Especificacaos");
        initComponents();
        this.id = id;
        setupForm();
    }
    ...
    private void setupForm() {
        ...
        validator.validarObrigatorio(txtTitulo);
    ...
    private void load() {
        Especificacao m = service.findById(id);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(txtTitulo, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 621, Short.MAX_VALUE)

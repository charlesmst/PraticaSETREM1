 ...
 * @author Charles
 */
public class FrmCor extends JPanelControleButtons {
...
//    JTableDataBinder table;
    ...
    public FrmCor() {
        ...
        service = new CorService();

        table.setListener(new JTableDataBinderListener<Cor>() {
    ...
    public void btnAddActionPerformed(ActionEvent evt) {
        ...
        JDialog dialog = new FrmCorCadastro();
    ...
    public void btnAlterarActionPerformed(ActionEvent evt) {
        defaultUpdateOperation(table, (i) -> {
            JDialog dialog = new FrmCorCadastro(i);
            dialog.setVisible(true);
        });

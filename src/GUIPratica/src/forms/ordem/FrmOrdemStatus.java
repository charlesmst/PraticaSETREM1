 ...
 * @author Charles
 */
public class FrmOrdemStatus extends JPanelControleButtons {

    private final OrdemStatusService service;
//    JTableDataBinder table;

    public FrmOrdemStatus() {
        initComponents();
        ...
        service = new OrdemStatusService();

        table.setListener(new JTableDataBinderListener<OrdemStatus>() {

            @Override
            public Collection<OrdemStatus> lista(String busca) throws ServiceException {
            ...
            @Override
            public Object[] addRow(OrdemStatus dado) {
                return new Object[]{dado.getId(), dado.getNome(), dado.isAtivo() ? Globals.iconeSuccess : Globals.iconeError};
    ...
    public void btnAddActionPerformed(ActionEvent evt) {
        ...
        JDialog dialog = new FrmOrdemStatusCadastro();
    ...
    public void btnAlterarActionPerformed(ActionEvent evt) {
        defaultUpdateOperation(table, (i) -> {
            JDialog dialog = new FrmOrdemStatusCadastro(i);
            dialog.setVisible(true);
        });

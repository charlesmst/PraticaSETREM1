 ...
 * @author Charles
 */
public class FrmVeiculo extends JPanelControleButtons {
...
//    JTableDataBinder table;
    ...
    public FrmVeiculo() {
        ...
        table.setListener(new JTableDataBinderListener<Veiculo>() {
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Placa", "Modelo", "Cor", "Ano", "Chassi"
            }
        ) {
    ...
    public void btnAddActionPerformed(ActionEvent evt) {
        ...
        JDialog dialog = new FrmVeiculoCadastro();
    ...
    public void btnAlterarActionPerformed(ActionEvent evt) {
        defaultUpdateOperation(table, (i) -> {
            JDialog dialog = new FrmVeiculoCadastro(i);
            dialog.setVisible(true);
        });

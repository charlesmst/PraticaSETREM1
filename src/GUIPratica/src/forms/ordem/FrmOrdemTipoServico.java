 ...
 * @author Charles
 */
public class FrmOrdemTipoServico extends JPanelControleButtons {

    private final OrdemTipoServicoService service;
//    JTableDataBinder table;
    ...
    public FrmOrdemTipoServico() {
        ...
        service = new OrdemTipoServicoService();

        table.setListener(new JTableDataBinderListener<OrdemTipoServico>() {

            @Override
            public Collection<OrdemTipoServico> lista(String busca) throws ServiceException {
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "Valor Padrão", "Status"
            }
        ) {
    ...
    public void btnAddActionPerformed(ActionEvent evt) {
        ...
        JDialog dialog = new FrmOrdemTipoServicoCadastro();
    ...
    public void btnAlterarActionPerformed(ActionEvent evt) {
        defaultUpdateOperation(table, (i) -> {
            JDialog dialog = new FrmOrdemTipoServicoCadastro(i);
            dialog.setVisible(true);
        });

...
public class FrmContaCategoriaCadastro extends JDialogController {
    ...
    private void setupForm() {
        ...
        validator.validarCustom(txtNome, (valor) -> service.unico(id, valor,jrbEntrada.isSelected()?ContaCategoria.TipoCategoria.entrada:ContaCategoria.TipoCategoria.saida), "Categoria já cadastrada");
...
//        ButtonGroup b
    ...
    private void initComponents() {
        ...
        jrbEntrada.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jrbEntrada.setText("ENTRADA");

        jrbSaida.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
